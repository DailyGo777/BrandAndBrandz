  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-screen py-20 bg-white">
        ...
        <div className="p-12 flex lg:flex-row flex-col justify-center items-stretch gap-12 bg-[#005A98]">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-between text-white gap-6 lg:gap-0">
            <h5 className="text-start font-semibold font-roboto text-white text-xl lg:text-2xl">
              Our Essence
            </h5>
            <h1 className="text-start font-bolld font-roboto text-white text-3xl lg:text-4xl">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-center items-center p-8 lg:p-16 gap-8">
          <div className="w-full lg:w-2/3 flex flex-col justify-start items-start p-4 border-1 border-grey-800 rounded-md gap-4 shadow-lg">
            <div className="flex flex-row justify-center items-center gap-4">
              <Eye color="#005A98" size={30} />
              <h1 className="text-xl md:text-3xl text-[#005A98] font-semibold">
                Our Mission
              </h1>
            </div>
            <p className="text-black text-md md:text-lg">
              To transform bold ideas into unforgettable brand experiences —
              through powerful design, smart strategy, and results that matter.
            </p>
          </div>
          <div className="w-full lg:w-2/3 flex flex-col justify-start items-start p-4 border-1 border-grey-800 rounded-md gap-4 shadow-lg">
            <div className="flex flex-row justify-center items-center gap-4">
        ...
        <div className="p-8 gap-8 flex flex-col justify-center items-center">
          <h1 className="text-3xl font-bold text-[#005A98] text-center">
            Our Core Values
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:px-12">
            {values.map((value, idx) => (
              ...
              >
                {value.logo}
                <h1 className="text-2xl font-semibold text-[#005A98] text-center">
                  {value.title}
                </h1>

    ...
    <section className='py-20 bg-white'>
        <div className='w-full p-12 flex lg:flex-row flex-col justify-evenly items-center gap-6 text-black'>
            <div className='w-full lg:w-1/4 h-full flex flex-col justify-center items-center gap-6 border-2 border-blue-200 rounded-md shadow-xl p-4'>
                ...
                <h3 className='text-[#4A6893] lg:text-xl text-lg font-semibold text-center'>Ready to Lead the Market?</h3>
            ...
            <div className='w-full lg:w-1/4  h-full flex flex-col justify-center items-center gap-6 border-2 border-blue-200 rounded-md shadow-xl p-4'>
                ...
                <h3 className='text-[#4A6893] lg:text-xl text-lg font-semibold text-center'>Brands That Break Through</h3>
            ...
            <div className='w-full lg:w-1/4 h-full flex flex-col justify-center items-center gap-6 border-2 border-blue-200 rounded-md shadow-xl p-4'>
                ...
                <h3 className='text-[#4A6893] lg:text-xl text-lg font-semibold text-center'>Total Brand Solutions</h3>

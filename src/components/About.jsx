...
const About = () => {
  return (
    <section className="relative py-20 bg-[#4A6893]">
      ...
      <div className="px-12 flex flex-row justify-center items-stretch gap-12">
        <div className="w-1/2">
          <Image
            src={img}
            alt="Who we are"
        ...
        <div className="w-1/2 flex flex-col justify-between text-white">
          ...
          <button className="px-6 py-2 bg-[#4A6893] w-60 text-white text-lg font-semibold rounded hover:bg-gray-100 hover:text-black transition border-2 border-white">
            Learn More About Us
          </button>
        </div>
      </div>
